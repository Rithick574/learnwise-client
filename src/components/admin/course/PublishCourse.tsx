...
export const PublishCourse: FC<BlockOrUnBlockProps> = ({ toggleModal, data, handleSave }) => {
  ...
  return (
    <div className={`w-2/6 ${theme === "light" ? "bg-white" : "bg-gray-900"} p-5 rounded-lg`}>
      ...
      <div className="flex gap-3 items-center my-2">
        ...
        >
          <option value="publish" className="capitalize">Publish</option>
          <option value="unpublish" className="capitalize">Unpublish</option>
        </select>
      </div>
      <button
